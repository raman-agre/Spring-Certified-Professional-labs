...
public class AccountClientTests {
	...
	public void listAccounts() {
		...
		String BASE_URL = "http://localhost:8080/accounts";
		Account[] accounts = restTemplate.getForObject(BASE_URL, Account[].class); // Modify this line to use the restTemplate
	...
	public void getAccount() {
		...
		// - Run the test and ensure that it passes.
		String BASE_URL = "http://localhost:8080/accounts/0";
		Account account = restTemplate.getForObject(BASE_URL, Account.class); // Modify this line to use the restTemplate
